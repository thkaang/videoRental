...
public class GraphicUI extends JFrame {
    ...
    private void initialize() {
        ...
        userCodeField = makeTextField(217, 54, 50, 26);

        makeLabel("Name:", 280, 59, 61, 16);
        nameField = makeTextField(324, 54, 120, 26);

        makeLabel("Birthday:", 462, 59, 60, 16);
        birthdayField = makeTextField(520, 54, 96, 26);
        ...
        titleField = makeTextField(182, 95, 100, 26);

        makeLabel("Price Code:", 294, 100, 75, 16);
        priceCodeSpinner = makeSpinner(362, 95, 75, 26, new String[] { "Regular", "New", "Children" });

        makeLabel("Type:", 445, 100, 61, 16);
        videoTypeSpinner = makeSpinner(480, 95, 55, 26, new String[] { "VHS", "CD", "DVD" });

        makeLabel("Rating:", 544, 100, 61, 16);
        ratingSpinner = makeSpinner(590, 95, 70, 26, new String[] { "Twelve", "Fifteen", "Eighteen" });
    ...
    private JSpinner makeSpinner(int x, int y, int width, int height, String[] menu) {
